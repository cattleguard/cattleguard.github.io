...
So, let's go beat a dead horse and take a look at the pre and post-period for the Target breach using a couple of unaffected retailers as predictors. *This isn't a great example, there are likely a bucket of confounders that make this less than convincing, but it will at least illustrate usage.*
